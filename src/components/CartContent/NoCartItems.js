  ...
  return (
    <div className="flex flex-col w-full items-center mt-10">
      <div className="mb-6">
        <FontAwesomeIcon
          icon={faCartShopping}
          className="text-lime-700 text-8xl py-2 pr-2"
        />
      </div>
      <div className="mb-6">
        <span className="block text-center font-bold text-4xl mb-2">
          Your cart has no items!
        </span>
        <p className="text-center text-sm text-black/[0.5] font-medium">
