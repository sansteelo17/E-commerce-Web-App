...
const HomeProductItem = (props) => {
  ...
  return (
    <div
      key={props.id}
      id={props.id}
      className="flex-col lg:w-1/5 sm:w-3/4 sm:px-8 md:px-12 lg:px-4 shadow-lg shadow-black/[0.1] md:mx-1 lg:mx-3 my-4 py-2 rounded-xl text-center border border-black/[0.1]"
    >
      <Link to={`/${props.id}`}>
